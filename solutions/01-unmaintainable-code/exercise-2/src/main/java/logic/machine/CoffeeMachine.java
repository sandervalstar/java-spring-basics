...
public class CoffeeMachine {
    ...
    public void brewV3(Recipe recipe) {
        System.out.println(String.format("Brewing %s...", recipe.getName()));
        coffeeDispenserV3.dispense(recipe.getCoffee(), recipe.getCoffeePercentage());
        milkDispenserV3.dispense(recipe.getMilk(), recipe.getMilkPercentage());
        sugarDispenserV3.dispense(recipe.getSugar(), recipe.getSugarPercentage());
        System.out.println("Done");
    }
}