...
public class CoffeeMachineTest {
    ...
    public void testV2() throws IOException, URISyntaxException {
        CoffeeMachine coffeeMachine = new CoffeeMachine();
        coffeeMachine.brewV2(generateTestRecipe());
        String expectedOutput = TestUtils.readFile("brew-latte-output-v2.txt");
        assertEquals(expectedOutput, outContent.toString());
    }

    @Test
    public void testV3() throws IOException, URISyntaxException {
        CoffeeMachine coffeeMachine = new CoffeeMachine();
        coffeeMachine.brewV3(generateTestRecipe());
        String expectedOutput = TestUtils.readFile("brew-latte-output-v3.txt");
        assertEquals(expectedOutput, outContent.toString());
    }
